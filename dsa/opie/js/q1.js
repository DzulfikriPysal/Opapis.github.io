...
function reinit(start){
	...
	if(check_drawing_type == 0 && start_check_1 == true){
		...
		stopTimer();
		drawing_7time = document.getElementById("timer").innerHTML;
	}
		...
		stopTimer();
		drawing_9time = document.getElementById("timer").innerHTML;
	}
	else if(check_drawing_type == 9 && start_check_10 == true){
		stopTimer();
		drawing_10_time = document.getElementById("timer").innerHTML;
	}
	else if(check_drawing_type == 10 && start_check_11 == true){
		stopTimer();
		drawing_11_time = document.getElementById("timer").innerHTML;
	}
	else if(check_drawing_type == 11 && start_check_12 == true){
		stopTimer();
		drawing_12_time = document.getElementById("timer").innerHTML;
	}
	else if(check_drawing_type == 12 && start_check_13 == true){
		stopTimer();
		drawing_13_time = document.getElementById("timer").innerHTML;
	}
	else if(check_drawing_type == 13 && start_check_14 == true){
		stopTimer();
		drawing_14_time = document.getElementById("timer").innerHTML;
	}
	...
	var con = 0;
		...
		if(check == 1){
			...
			if(randIndex == 0){
				...
				start_check_10 = false;
				document.getElementById('btndownload').style.visibility = 'hidden';
				con = 1;
				
			}
			else if(randIndex == 10){
				start_check_11 = false;
				document.getElementById('btndownload').style.visibility = 'hidden';
				con = 1;
				
			}
			else if(randIndex == 11){
				start_check_12 = false;
				document.getElementById('btndownload').style.visibility = 'hidden';
				con = 1;
				
			}
			else if(randIndex == 12){
				start_check_13 = false;
				document.getElementById('btndownload').style.visibility = 'hidden';
				con = 1;
				
			}
			else if(randIndex == 13){
				start_check_14 = false;
				document.getElementById('btndownload').style.visibility = 'hidden';
				con = 1;
